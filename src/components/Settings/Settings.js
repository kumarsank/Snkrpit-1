...
import {
    Container, View, Content, Text, H1, List, ListItem, Left, Right, Icon, Separator, Body,
} from 'native-base';
        ...
        return (
            <Container>
                <Content>
                    ...
                    <ListItem onPress={() => navigate('Editprofile')} noBorder icon style={[styles.listborder]} >
                        <Left>
